...
const openingSection: AlbumSection = {
  ...
  stickers: [
    ...
    makeSticker("FWC", 9,  "Museum -1930 Uruguay", "special"),
    makeSticker("FWC", 10, "Museum -1934 & 1938 Italia", "special"),
    makeSticker("FWC", 11, "Museum -1950 Uruguay & 1954 Alemania", "special"),
    makeSticker("FWC", 12, "Museum -1958 & 1962 Brasil", "special"),
    makeSticker("FWC", 13, "Museum -1966 Inglaterra & 1970 Brasil", "special"),
    makeSticker("FWC", 14, "Museum -1974 Alemania & 1978 Argentina", "special"),
    makeSticker("FWC", 15, "Museum -1982 Italia & 1986 Argentina", "special"),
    makeSticker("FWC", 16, "Museum -1990 Alemania & 1994 Brasil", "special"),
    makeSticker("FWC", 17, "Museum -1998 Francia & 2002 Brasil", "special"),
    makeSticker("FWC", 18, "Museum -2006 Italia & 2010 España", "special"),
    makeSticker("FWC", 19, "Museum -2014 Alemania & 2018 Francia & 2022 Argentina", "special"),
  ],
};
